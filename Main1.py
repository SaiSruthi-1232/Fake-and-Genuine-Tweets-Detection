...
main = tkinter.Tk()
main.title("Twitter polarity analysis") #designing main screen
...
def firstAlgorithm():
    ...
    for i in range(len(process)):
        ...
        if result =='Positive' or result == 'Neutral':
            ...
            if len(neg) > 0:
                sarcastic.append("Genuine")
            else:
                sarcastic.append("Fake")
        else:
            sarcastic.append("Genuine")
...
font = ('times', 16, 'bold')
title = Label(main, text='Twitter polarity analysis')
...
gButton = Button(main, text=" Graph", command=sarcasticGraph)
